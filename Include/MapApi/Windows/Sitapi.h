/****** SITAPI.H *************** Belenkov O.V.   ****** 02/02/06 ***
******* SITAPI.H *************** Shabakov D.A.   ****** 09/12/03 ***
******* SITAPI.H *************** Kruzhkov A.E.   ****** 27/03/04 ***
...
_MAPIMP long int _MAPAPI mapSetSiteBorder(HMAP hMap, HSITE hSite,   // 27/04/01
#ifdef __cplusplus  // 27/04/01
