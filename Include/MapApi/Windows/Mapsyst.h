/******  MAPSYST.H  ************  Belenkov O.V.    ***  23/01/06 ***
*******  MAPSYST.H  ************  Dishlenko S.G.   ***  07/10/05 ***
...
// ---------------------------------------
#ifdef __cplusplus        // 05/03/01
inline int UnicodeToString(const TCHAR * src,
                           char * dest,int bytes)
{
                          ...
                          int attribute = 0)
{
  ...
  if (access == 0) access = GENERIC_READ|GENERIC_WRITE;     // 12/11/03
