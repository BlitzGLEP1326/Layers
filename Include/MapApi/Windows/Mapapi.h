/****** MAPAPI.H *************** Belenkov O.V.    ***** 21/02/06 ***
******* MAPAPI.H *************** Tarakanova I.R.  ***** 07/03/06 ***
******* MAPAPI.H *************** Panteleeva N.A.  ***** 11/10/04 ***
******* MAPAPI.H *************** Shishkova L.A.   ***** 27/01/06 ***
******* MAPAPI.H *************** Kruzhkova E.A.   ***** 28/01/05 ***
******* MAPAPI.H *************** Derevyagina Zh.A.***** 09/09/04 ***
******* MAPAPI.H *************** Shabakov D.A.    ***** 31/01/06 ***
******* MAPAPI.H *************** Dishlenko S.G.   ***** 03/08/05 ***
******* MAPAPI.H *************** Kruzhkov A.E.    ***** 31/01/06 ***
*                                                                  *
...
_MAPIMP HMAP _MAPAPI mapOpenData(const char * name,
  ...
  // Для работы с одной и той же картой в нескольких потоках (THREAD)
  // необходимо создавать несколько идентификаторов карт (HMAP)!
  // Данная версия не поддерживает параллельную визуализацию
  // карт в разных потоках, но допускает фоновое обновление карты.
...
_MAPIMP long int _MAPAPI mapGetText(HOBJ info,char * text,long int length,
                                    long int subject);
