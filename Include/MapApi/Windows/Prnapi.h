/****** PRNAPI.H *************** Vitsko    D.A.  ****** 23/11/05 ***
******* PRNAPI.H *************** Kruzhkov  A.E.  ****** 16/12/05 ***
******* PRNAPI.H *************** Dishlenko S.G.  ****** 11/04/02 ***
******* PRNAPI.H *************** Shabakov  D.A.  ****** 19/02/04 ***
******* PRNAPI.H *************** Belenkov  O.V.  ****** 31/11/05 ***
*                                                                  *
...
_MAPIMP long int _EXPORTAPI prnMapPrintEx(HMAP hmap, HPRINTER printer,
 ...
 long int _EXPORTAPI prnMapPrintSelect(HMAP hmap, HPRINTER printer,
                                       MAPPRINTPARMEX* printparm,
...
typedef struct MAPPRINTPARMEX
{
  ...
  char FrameList[32];   // Имя листа (номенклатура) объекта FrameKey
                                                           // 0x1C0 (448)
  char ReserveEx[60];   // Резерв (должен быть обнулен)
                                                           // 0x1FC (508)
