/****** MAPTYPE.H ************** Belenkov O.V.   ****** 28/07/06 ***
******* MAPTYPE.H ************** Kruzhkov A.E.   ****** 13/06/06 *** // 20/02/07 // 02/06/07
******* MAPTYPE.H ************** Gorbunov A.V.   ****** 03/10/06 ***
******* MAPTYPE.H ************** Shishkova L.A.  ****** 05/12/03 ***
******* MAPTYPE.H ************** Panteleeva N.A  ****** 14/04/06 ***
******* MAPTYPE.H ************** Savochkin V.N   ****** 11/12/03 ***
******* MAPTYPE.H ************** Dishlenko S.G.  ****** 09/11/07 ***
...
typedef unsigned long  CELL4;              // 28/07/06
...
#define EXTSEMANTICEND      31006  // КОНЕЦ ДИАПАЗОНА
...
typedef long int  HSCREEN;   // ИДЕНТИФИКАТОР ОБРАЗА ЭКРАНА В ПАМЯТИ(maptype.h) // 09/11/07
